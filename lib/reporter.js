...
var HtmlDetailedReporter = function (baseReporterDecorator, config, logger, helper, formatError) {
    ...
    function getRelativePaths() {
        ...
        var fontawesome = require.resolve('@fontawesome');
        if (!fontawesomey) log.error('FontAwesome is not found!');
        else {
            ...
            paths.fontawesome = fontawesome + '/fontawesome-free'.replace(/\\/g, '/');
        }
